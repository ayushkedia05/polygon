...
function Login() {
  ...
  const handleRegister = (e) => {
    ...
    axios.post("https://codefuryserver.herokuapp.com/signup/", user).then((res) => {
        ...
        <div className='bg-neutral-500 rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
          ...
          <div className='w-3/5 p-5 '>
            <div className='flex text-left font-bold'>
              <span className='text-2xl'>DREAM</span>
              <span className='text-1xl font-bold text-yellow-500'>BIG</span>
            </div>
            <div className='py-5'>
